...
export const Compress = () => {
	...
	return (
		<section className="relative bg-surface rounded-lg shadow-md p-8 w-full h-full max-h-5/13 mt-16">
			<Title
				as="h1"
				title="Compression"
			...
			<div className="flex gap-8 w-full h-full">
				<div className="h-full flex flex-col gap-4 max-w-md w-full justify-center">
					<div className="flex flex-col gap-2">
						<p className="text-lg text-primary-text max-w-2xl leading-4">
							Reduce size without losing quality.
						</p>
						<p className="text-sm text-primary-text/70 max-w-2xl mb-4 leading-4">
